...
**[v0.8.1](https://github.com/stoatworks-labs/zero-eq/releases/tag/v0.8.1)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`zero-eq-0.8.1-macos-universal.dmg`](https://github.com/stoatworks-labs/zero-eq/releases/download/v0.8.1/zero-eq-0.8.1-macos-universal.dmg) | 11 MB |
| Universal (Apple Silicon + Intel) · .pkg installer | [`zero-eq-0.8.1-macos-universal.pkg`](https://github.com/stoatworks-labs/zero-eq/releases/download/v0.8.1/zero-eq-0.8.1-macos-universal.pkg) | 11 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`zero-eq-0.8.1-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/zero-eq/releases/download/v0.8.1/zero-eq-0.8.1-windows-x86_64-setup.exe) | 3.0 MB |
| ARM64 · .exe installer | [`zero-eq-0.8.1-windows-aarch64-setup.exe`](https://github.com/stoatworks-labs/zero-eq/releases/download/v0.8.1/zero-eq-0.8.1-windows-aarch64-setup.exe) | 2.7 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .deb package (Debian/Ubuntu) | [`zero-eq_0.8.1_amd64.deb`](https://github.com/stoatworks-labs/zero-eq/releases/download/v0.8.1/zero-eq_0.8.1_amd64.deb) | 2.3 MB |
| ARM64 · .deb package (Debian/Ubuntu) | [`zero-eq_0.8.1_arm64.deb`](https://github.com/stoatworks-labs/zero-eq/releases/download/v0.8.1/zero-eq_0.8.1_arm64.deb) | 2.3 MB |
| x64 · .rpm package (Fedora/RHEL) | [`zero-eq-0.8.1-1.x86_64.rpm`](https://github.com/stoatworks-labs/zero-eq/releases/download/v0.8.1/zero-eq-0.8.1-1.x86_64.rpm) | 2.3 MB |
| ARM64 · .rpm package (Fedora/RHEL) | [`zero-eq-0.8.1-1.aarch64.rpm`](https://github.com/stoatworks-labs/zero-eq/releases/download/v0.8.1/zero-eq-0.8.1-1.aarch64.rpm) | 2.3 MB |
